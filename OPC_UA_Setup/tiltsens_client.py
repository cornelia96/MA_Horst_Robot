...
tiltsensor = objects.get_children()[3]

print(f"HIER WICHTIG {tiltsensor.get_children()}")

tilt_detected = tiltsensor.get_children()[0]
...
GPIO_PIN = constants.tiltsens_pin
GPIO.setup(GPIO_PIN, GPIO.IN)
   
# Diese AusgabeFunktion wird bei Signaldetektion ausgefuehrt
def ausgabeFunktion(null):
        tilt_detected.set_value(True)
        sleep(1)
        tilt_detected.set_value(False)
